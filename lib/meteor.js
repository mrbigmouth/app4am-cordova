...
_.extend(Meteor, {                                                                                  // 11
  ...
  //   Meteor._inherit(ClassB, ClassA).                                                             // 118
...
Meteor.bindEnvironment = function (func, onException, _this) {                                      // 27
  ...
  return function (/* arguments */) {                                                               // 43
    ...
    try {                                                                                           // 45
      ...
      // note: callback-hook currently relies on the fact that if onException                       // 49
      // throws in the browser, the wrapped call throws.                                            // 50
      onException(e);                                                                               // 51
    } finally {                                                                                     // 52
      currentValues = savedValues;                                                                  // 53
    }                                                                                               // 54
    return ret;                                                                                     // 55
  };                                                                                                // 56
};                                                                                                  // 57
                                                                                                    // 58
Meteor._nodeCodeMustBeInFiber = function () {                                                       // 59
  // no-op on browser                                                                               // 60
};                                                                                                  // 61
                                                                                                    // 62
//////////////////////////////////////////////////////////////////////////////////////////////////////
